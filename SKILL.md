...
| El usuario nombra una entidad que no existe en los datos | No es ambigüedad — dilo explícito ("Empresa 25 no existe entre los registros") y muestra qué valores sí hay; nunca respondas con un total en 0 o cualquier cifra que sugiera que el registro existe pero está vacío |
